...
PLAYBOOKS = {
    "intel": {
        ...
        # no become_user -> run as cloudadmin (or as playbook dictates)
    },
    "amd": {
...
def run_playbook(form: cgi.FieldStorage):
    ...
    # (We still honor user's "become" checkbox to allow privilege escalation when needed in other playbooks.)
    if become_user:
